...
public class OpenWithPlugin extends CordovaPlugin {
  ...
  private final int DEBUG = 0; // Maximal verbosity, log everything
  private final int INFO = 10; // Default verbosity, log interesting stuff only
  private final int WARN = 20; // Low verbosity, log only warnings and errors
  private final int ERROR = 30; // Minimal verbosity, log only errors
  ...
  private CallbackContext loggerContext; // Callback to the javascript logger method */
